...
let SciProjectsShema = new Schema({
    ...
    sciProjects: {type: Object, required: true},//科研项目
    // scienceAward: {type:Object, required: true}//科研成果奖励
})
let SciProjectsMoudel = mongoose.model('SciProjects',SciProjectsShema);
SciProjectsMoudel.ensureIndexes(function(err) {
    if(err) {
        console.log('err--->')
    } else {
        console.log('success--->');
...
module.exports = SciProjectsMoudel;