...
let SciPapersMoudel = mongoose.model('SciPapers',SciPapersShema);
SciPapersMoudel.ensureIndexes(function(err) {
    if(err) {
        console.log('err--->')
    } else {
        console.log('success--->');
...
module.exports = SciPapersMoudel;